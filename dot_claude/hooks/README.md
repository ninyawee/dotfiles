...
|------|---------|----------|-----------|
| **Dev server blocker** | `Bash` | Blocks `npm run dev` etc. outside zellij — ensures log access | 2 (blocks) |
| **Zellij reminder** | `Bash` | Suggests zellij for long-running commands (npm test, cargo build, docker) | 0 (warns) |
